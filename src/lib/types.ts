...
export type CustodyEvent = {
  type: 'transfer' | 'inventory_addition' | 'other';
  date: string;
  ipAddress: string;
  ownerId?: string;
  ownerName?: string;
...
export type CampaignPlacement = 'dashboard_main' | 'dashboard_sidebar' | 'event_list' | 'welcome_banner' | 'bike_passport' | 'bike_blindaje' | 'ticket_welcome_kit' | 'public_event_board';
